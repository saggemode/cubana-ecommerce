...
export default function Verification({
  ...
  const previewText = `Verify your email and Loggin code`
        ...
        <Body className="my-auto mx-auto w-full max-w-lg">
          <Container className="border border-solid border-neutral-500/25 rounded mx-auto p-6">
            ...
            <Text>
              ...
              your open browser window and we&rsquoll help you get signed in. If
              you didn&rsquot try to login, you can safely ignore this email.
            </Text>
